...
Namespace TensorFlowImageClassification.ImageHelpers
	Public Module ImageValidationExtensions
		...
		Public Function IsValidImage(image() As Byte) As Boolean
			...
			Return imageFormat = TensorFlowImageClassification.ImageHelpers.ImageValidationExtensions.ImageFormat.jpeg OrElse imageFormat = TensorFlowImageClassification.ImageHelpers.ImageValidationExtensions.ImageFormat.png
		End Function
