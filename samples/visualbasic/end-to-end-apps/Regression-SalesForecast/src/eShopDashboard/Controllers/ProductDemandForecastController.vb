...
Namespace eShopDashboard.Controllers
	...
	Public Class ProductDemandForecastController
		...
		Private ReadOnly productSalesModel As MLModelEngine(Of ProductData, ProductUnitPrediction)

		Public Sub New(appSettings As IOptionsSnapshot(Of AppSettings), productSalesModel As MLModelEngine(Of ProductData, ProductUnitPrediction))
