...
Namespace eShopForecastModelsTrainer
	Public Class ProductModelHelper
		...
		Public Shared Sub TestPrediction(mlContext As MLContext, Optional outputModelPath As String = "product_month_fastTreeTweedie.zip")
			...
			Dim predictionEngine = mlContext.Model.CreatePredictionEngine(Of ProductData, ProductUnitPrediction)(trainedModel)
			...
			Dim prediction As ProductUnitPrediction = predictionEngine.Predict(dataSample)
