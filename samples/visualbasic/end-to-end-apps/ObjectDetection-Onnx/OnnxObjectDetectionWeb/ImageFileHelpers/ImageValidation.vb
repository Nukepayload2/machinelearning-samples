...
Namespace OnnxObjectDetectionWeb.Infrastructure
	Public Module ImageValidationExtensions
		...
		Public Function IsValidImage(image() As Byte) As Boolean
			...
			Return imageFormat = OnnxObjectDetectionWeb.Infrastructure.ImageValidationExtensions.ImageFormat.jpeg OrElse imageFormat = OnnxObjectDetectionWeb.Infrastructure.ImageValidationExtensions.ImageFormat.png
		End Function
