...
Namespace ImageClassification.Model
    Public Class ModelBuilder
        ...
        Public Sub BuildAndTrain(imageSet As IEnumerable(Of ImageData))
            ...
            Dim trainTestData As TrainTestData = mlContext.Data.TrainTestSplit(shuffledFullImagesDataset, testFraction:=0.1)
            ...
            predictions.ForEach(Sub(pred) ConsoleWriteImagePrediction(pred.ImagePath, pred.Label, pred.PredictedLabelValue, pred.Score.Max()))
