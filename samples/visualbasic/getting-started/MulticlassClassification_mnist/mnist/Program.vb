	...
	Friend Class Program
		...
		Public Shared Sub Train(mlContext As MLContext)
			Try
				...
				Dim dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("Label", "Number").Append(mlContext.Transforms.Concatenate("Features", NameOf(InputData.PixelValues)).AppendCacheCheckpoint(mlContext))
