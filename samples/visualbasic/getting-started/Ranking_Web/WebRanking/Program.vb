...
Namespace WebRanking
    Friend Class Program
        ...
        Private Shared ReadOnly InputPath As String = Path.Combine(AssetsPath, "Input")
        Private Shared ReadOnly OutputPath As String = Path.Combine(AssetsPath, "Output")
        Private Shared ReadOnly TrainDatasetPath As String = Path.Combine(InputPath, "MSLRWeb10KTrain720kRows.tsv")
        Private Shared ReadOnly ValidationDatasetPath As String = Path.Combine(InputPath, "MSLRWeb10KValidate240kRows.tsv")
        Private Shared ReadOnly TestDatasetPath As String = Path.Combine(InputPath, "MSLRWeb10KTest240kRows.tsv")
        Private Shared ReadOnly ModelPath As String = Path.Combine(OutputPath, "RankingModel.zip")
        ...
        Shared Sub Main(args() As String)
            ...
            Try
                ...
                Dim trainData As IDataView = mlContext.Data.LoadFromTextFile(Of SearchResultData)(TrainDatasetPath, separatorChar:=vbTab, hasHeader:=True)
                ...
                Dim validationData As IDataView = mlContext.Data.LoadFromTextFile(Of SearchResultData)(ValidationDatasetPath, separatorChar:=vbTab, hasHeader:=False)
                ...
                Dim testData As IDataView = mlContext.Data.LoadFromTextFile(Of SearchResultData)(TestDatasetPath, separatorChar:=vbTab, hasHeader:=False)
